...
Sales::Sales(const int _base_salary, const QString& _name, const QDate& rdate)
...
void Sales::SetSalary(const int _base_salary)
{
...
int Sales::AddSalaryAllTime(const QDate* const& dateStartWork)
{
        int procentYear=5;
